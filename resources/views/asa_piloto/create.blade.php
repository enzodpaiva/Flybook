...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Cadastro De Asa</div>

                <div class="card-body">
                    
                    <form class="form-horizontal" method="POST" action="/piloto/asa-store">
                        @csrf
                <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                  <input id="Nome" name="Nome" placeholder="" class="form-control input-md mb-4" required="" type="text">
                  </div>
                    ...
                    {{-- <div class="mb-4">
                      ...
                      <em>Fabricante</em>
                        <select data-placeholder="Your Favorite Type of Bear" name="fabricante" class="chosen-select" tabindex="7">
                          ...
                          <option value="{{$cat->id}}">{{$cat->name}} - cnpj: {{$cat->cnpj}}</option>
                          @endforeach
                        </select>
                      </div>
                </div>
