                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="idade" type="number" class="form-control @error('idade') is-invalid @enderror" name="idade" value="{{ old('idade') }}" required autocomplete="idade" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="level" type="number" value="0" placeholder="0" class="form-control @error('level') is-invalid @enderror" name="level" value="{{ old('level') }}" readonly autocomplete="level" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="registro_abp" type="text" class="form-control @error('registro_abp') is-invalid @enderror" name="registro_abp" value="{{ old('registro_abp') }}" autocomplete="registro_abp" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="validade_habilitacao" type="date" class="form-control @error('validade_habilitacao') is-invalid @enderror" name="validade_habilitacao" value="{{ old('validade_habilitacao') }}" autocomplete="validade_habilitacao" autofocus>
